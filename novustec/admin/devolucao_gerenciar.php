                        ...
                        <div class="panel-body">
                           <div class="dataTable_wrapper">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                 ...
                                 <tbody> 
                                    <?php
                                       $sql = "SELECT pagamento_id, codigo_pagamento, nome, sobrenome, DATE_FORMAT(data_cadastro, '%d/%m/%Y') AS data, valor_total FROM ordem_pagamentos WHERE tipo='devolucao'";
