      ...
      <div id="wrapper">
         ...
         <div id="page-wrapper">
            <div class="container-fluid">
               <div class="row">
                  <div class="col-lg-12">
                     <h1 class="page-header">Cadastrar Devolução</h1>
                  </div>
                  <div class="col-lg-12">
                                       ...
                                       if ($result->num_rows > 0) {
                                           ...
                                           while($row = $result->fetch_assoc()) {
                                               ...
                                               echo "<td>".$row["email"]."</td>";
                                                echo "<td><center><a class='btn btn-primary' href='devolucao_cadastro.php?usuarios_usuario_id=".$row["usuario_id"]."&nome=".ucfirst($row["nome"])."&sobrenome=".ucfirst($row["sobrenome"])."'>Cadastrar Devolução</a></center></td>";                      
                                               echo "</tr>";
