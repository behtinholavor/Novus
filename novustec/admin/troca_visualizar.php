        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">Visualizar Troca</h1> 
                    ...
                    <div style="margin-bottom: 15px;" class="col-lg-12">  
                     ...
                     <div class="form-group">
                        ...
                        <input readonly class="form-control" name="codigo" id="codigo" type="text" placeholder="" value="<?php echo $row['codigo']; ?>" required=""> 
                     </div>
                  </div>
