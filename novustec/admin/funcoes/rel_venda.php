...
$comando="SELECT codigo_venda, nome, subtotal, valor_total, desconto, DATE_FORMAT(data_cadastro, '%d/%m/%Y') AS data from ordem_venda WHERE data_cadastro BETWEEN STR_TO_DATE('$data_inicial', '%Y-%m-%d') AND STR_TO_DATE('$data_final', '%Y-%m-%d')";
    ...
    $html.="<h1 style='padding: 0px; margin: 0px; text-align: center; font-family: Helvetica Neue,Helvetica,Arial,sans-serif;'>Ordens de Vendas</h1>";  
    ...
    $html.="<TR >";
    $html.="<th style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; padding: 10px 20px; border: 1px solid #DDD; font-weight: bold; font-size: 14px; text-align: center;'>VENDA</th>";
    ...
    $html.="<th style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; padding: 10px 20px; border: 1px solid #DDD; font-weight: bold; font-size: 14px; text-align: center;'>SUBTOTAL</th>";
    $html.="<th style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; padding: 10px 20px; border: 1px solid #DDD; font-weight: bold; font-size: 14px; text-align: center;'>DESCONTO</th>";
    ...
    $sub=$dados[valor_total];
		$html.="<tr>";
    $html.="<td style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; border: 1px solid #DDD; padding: 10px 10px; text-align: center; font-size: 12px;'>$dados[codigo_venda]</td>";
    ...
    $html.="<td style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; border: 1px solid #DDD; padding: 10px 10px; text-align: center; font-size: 12px;'>R$ $dados[subtotal]</td>";
    $html.="<td style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; border: 1px solid #DDD; padding: 10px 10px; text-align: center; font-size: 12px;'>$dados[desconto]%</td>";
    ...
    $total+=$sub;
		...
		$html.="<tr>";
    $html.="<td colspan='5' style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; border: 1px solid #DDD; padding: 10px 10px; text-align: right; font-size: 12px; font-weight: bold;'>TOTAL:</td>";    
...
$dompdf->render();
$dompdf->stream("rel_vendas_$hoje.pdf");
?>