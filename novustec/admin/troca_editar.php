...
$sql = "SELECT ordem_troca_id, ordem_venda_id, codigo, desconto, subtotal, valor_total, nome, sobrenome, DATE_FORMAT(data_cadastro, '%d/%m/%Y') AS data, telefone, descricao FROM ordem_troca WHERE ordem_troca_id = '$troca_id'";
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">Editar Troca</h1> 
                    ...
                    <div style="margin-bottom: 15px;" class="col-lg-12">  
                     ...
                     <div class="col-lg-12">
                     <form id="venda" name="venda" method="post" action="./funcoes/troca_edit.php" role="form" autocomplete="false">
                     <div class="form-group">
                        <label>Código Troca*</label>
                        <input readonly class="form-control" name="codigo_venda" id="codigo" type="text" placeholder="" value="<?php echo $row['codigo']; ?>" required=""> 
                     </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>Nome*</label>
                        <input class="form-control" placeholder="Nome.." id="nome" name="nome" value="<?php echo $row['nome']; ?>" required="">  
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>Sobrenome*</label>
                        <input class="form-control" placeholder="Sobrenome.." name="sobrenome" required="" value="<?php echo $row['sobrenome']; ?>">  
                     </div>
                  </div>     
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>Telefone*</label>
                        <input id="telefone" class="form-control" placeholder="Telefone.." name="telefone" value="<?php echo $row['telefone']; ?>" required="">  
                     </div>
                  </div> 
                                    <div class="col-lg-6">
                     <div class="form-group">
                  ...
                  <div class="col-lg-12">
                     <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" name="descricao" ><?php echo $row['descricao'];; ?></textarea>  
                     </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                                              <?php
include './funcoes/config.php';
$sql = "select P.codigo, P.produto_id, P.valor_original_total, P.nome, P.tamanho, P.sexo, P.status, P.valor_total, V.produtos_produto_id, V.ordem_troca_ordem_troca_id
from produtos P
inner join troca_produtos V on P.produto_id = V.produtos_produto_id WHERE V.ordem_troca_ordem_troca_id = '$troca_id'";
$result = $conn->query($sql);
...
echo '<tr style=" font-weight: bold; background-color: #eee;">     
               ...
               ?>
                  ...
                  <div style="margin-bottom:20px" class="col-lg-12">
                     ...
                     <input name="troca_id" type="hidden" value="<?PHP echo $troca_id; ?>">
                      <input name="troca_editar" id="troca_editar" type="hidden" value="troca_editar">
                     <div id="sucesso"></div>
                  </div>
