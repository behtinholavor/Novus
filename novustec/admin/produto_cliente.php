                        ...
                        <div class="panel-body">
                           <div class="dataTable_wrapper">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                 ...
                                 <tbody> 
                                    <?php
                                       $sql = "SELECT usuario_id, nome, sobrenome, email FROM usuarios WHERE nivel_usuario = '1' AND ativado='1'";
                                       ...
                                       if ($result->num_rows > 0) {
                                           ...
                                           while($row = $result->fetch_assoc()) {
                                               ...
                                               echo "<td><center><a class='btn btn-primary' href='produto_cadastro.php?usuarios_usuario_id=".$row["usuario_id"]."&nome=".ucfirst($row["nome"])."&sobrenome=".ucfirst($row["sobrenome"])."'>Cadastrar Produto</a></center></td>";                                               
                                                echo "</tr>";
                                               echo "<input type='hidden' name='fornecedor' value='".ucfirst($row["nome"])." ".ucfirst($row["sobrenome"])."'>";
                                           }
                                       } else {
                                           echo "0 results";
                                       }
