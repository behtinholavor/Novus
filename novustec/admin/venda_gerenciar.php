    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Gerenciar Vendas</h1>        
                    </div>  
...
$sql = "SELECT ordem_venda_id, codigo_venda, nome, sobrenome, valor_total, DATE_FORMAT(data_cadastro, '%d/%m/%Y') AS data, telefone, descricao FROM ordem_venda";
...
if ($result->num_rows > 0) {
    ...
    $remover1 = "<a disabled title='Remover' class='confirmation not-active' href='./funcoes/produto_remove.php?produto_id=".$row["produto_id"]."'><i style='margin-right: 5px; color: #C17A78; ' class='fa fa-minus-square fa-lg '></i></a>";
      ...
      $converte_valor = number_format($valor,2,",",".");
        ...
        <a title='Visualizar' href='venda_visualizar.php?venda_id=".$row["ordem_venda_id"]."'><i style='margin-right: 5px; color: #3c763d;' class='fa fa-check-square fa-lg'></i></a>
        <a title='Editar' href='venda_editar.php?venda_id=".$row["ordem_venda_id"]."'><i style='margin-right: 5px; color: #31708f;' class='fa fa-pencil-square fa-lg'></i></a>
        $remover1
        </td>";
        echo "</tr>";
