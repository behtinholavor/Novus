         ...
         <div id="page-wrapper">
            <div class="container-fluid">
               <div class="row">
                  ...
                  <form id="venda" name="venda" method="post" action="./funcoes/pagamento_add.php" role="form" autocomplete="false">
                     <div class="col-lg-12">
                     ...
                     <?php
                        $sql = "SELECT valor_cliente FROM produtos WHERE status = 'vendido' AND usuarios_usuario_id = '".$usuario_id."' AND pagamento = '0'";
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                           ...
                           <input readonly <?PHP echo $disabled; ?> type="text" class="form-control" name="valor_total" id="valor_total" type="text" placeholder="Data.." value="R$ <?PHP echo $top; ?>" required=""> 
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group">
                        ...
                        <div class="col-lg-12">
                           <div class="panel panel-default">
                              <div class="panel-heading">
                                 Produtos    
                                 <p style="margin-bottom: 15px; padding-top: 5px; margin-right: 20px; float:right ; font-size: 11px; font-weight: bold;">Total Produtos Vendidos: <?PHP echo $contator; ?></p>
                                                ...
                                                <div class="table-responsive">
                                                   <table class="table table-striped table-bordered table-hover">
                                                      ...
                                                      <tbody>
                                                         <?php
                                                         include './funcoes/config.php';
                                                            $sql = "SELECT produto_id, codigo, nome, tamanho, desconto, sexo, valor_cliente, status FROM produtos WHERE status = 'vendido' AND usuarios_usuario_id = '".$usuario_id."' AND pagamento= '0'";
                                                            $result = $conn->query($sql);
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                ...
                                                                while($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    echo "<td>R$ ".$row["valor_cliente"]."</td><input type='hidden' name='produto_id[".$row['produto_id']."]'' value='".$row['produto_id']."'>";
                                                                    echo "</tr>";
