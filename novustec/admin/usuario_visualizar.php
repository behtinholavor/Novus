    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Visualizar Usuário<p style='float:right ; font-size: 11px; font-weight: bold;'>(Total de produtos: <?php echo $total; ?>)</p></h1>     
                    </div>  
           
                    <form name="profile" method="post" action="" role="form" autocomplete="false">     
                     <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                     <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Tamanho.." name="Sobrenome" value="<?php echo $row[3]; ?>" required="" disabled>  
                     </div>
                  </div>  
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>E-mail</label>
                        <input class="form-control" placeholder="Tamanho.." name="email" value="<?php echo $row[4]; ?>" required="" disabled>  
                     </div>
                  </div>  
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>Senha</label>
                        <input class="form-control" placeholder="Tamanho.." name="senha" type="password" value="<?php echo $row[5]; ?>" required="" disabled>  
                     </div>
                  </div>        
                                <div class="col-lg-6">
                     <div class="form-group">
                        <label>Telefone</label>
                        <input class="form-control" placeholder="Tamanho.." name="tamanho" value="<?php echo $row[6]; ?>" required="" disabled>  
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>Nivel Usuário*</label>
                        <select class="form-control" name="nivel" required="" disabled>
                  ...
                  <div class="col-lg-12">
                     <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" name="descricao" disabled><?php echo $row[8]; ?></textarea>  
                     </div>
                  </div>
