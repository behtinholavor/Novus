            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div style="margin-bottom: 15px;" class="col-lg-12">  
                     ...
                     <div class="col-lg-12">
                     <form id="venda" name="venda" method="post" action="./funcoes/venda_edit.php" role="form" autocomplete="false">
...
$sql = "select P.codigo, P.produto_id, P.nome, P.tamanho, P.valor_original_total, P.sexo, P.status, P.valor_total, V.produtos_produto_id, V.ordem_venda_ordem_venda_id
from produtos P
 ...
 echo '<tr style=" font-weight: bold; background-color: #eee;">     
               ...
               ?>
                  ...
                  <div style="margin-bottom:20px" class="col-lg-12">
                     ...
                     <input name="ordem_id" type="hidden" value="<?PHP echo $venda_id; ?>">
                      <input name="venda_editar" id="venda_editar" type="hidden" value="venda_editar">
                     <div id="sucesso"></div>
                  </div>
